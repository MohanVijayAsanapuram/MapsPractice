package com.spiders.maps.mapspractice.loadmore_swiperefreshlayout;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(
                    R.layout.loadmore_swiperefresh_cardview_of_rv, parent, false);

            vh = new StudentViewHolder(v);
        } else {
            View v = LayoutInflater.from(parent.getContext()).inflate(
                    R.layout.loadmore_swiperefresh_progressbarlayout, parent, false);
